...
<body>
    ...
    <div class="container md-3 mt-3 border w-50">
                <h2><g:message code="message.create_department"/></h2>
         <g:form name="createDepartmentForm" controller="department" action="createDepartment">
             <div class="mb-3">
                 <label class="form-label" for="department_name"><g:message code="message.department_name"/></label>
                 <input id="department_name" name="department_name" class="form-control" required="true" maxlength="10"><br/>
             </div>
                <g:actionSubmit type="submit" class="btn btn-primary" value="${g.message (code: 'message.create_department')}" action="createDepartment"/>
         </g:form>
    </div>
